        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">Data Teacher</h1>
                            <br>

                            <div class="row">
                                <div class="col-lg-12 margin-tb">
                                    <div class="pull-right">
                                        <a class="btn btn-success" href="{{ route('teacher.create') }}">Tambah Guru Baru</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <form action="{{ route('teacher.destroy', $user->id) }}" method="POST">
                                                <a class="btn btn-primary btn-sm" href="{{ route('teacher.edit',$user->id) }}">Edit</a>
                                                @csrf
                                                @method('DELETE')
